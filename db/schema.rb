...
ActiveRecord::Schema.define(version: 20181127124730) do
  ...
  create_table "domains", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name"
    t.string "org_name"
    t.string "logo_uid"
    t.string "logo_name"
  ...
  create_table "projects", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    ...
    t.text "next_steps"
    t.date "ce_date"
    t.text "brand_owner_comments"
    t.text "brand_owner_next_steps"
    ...
    t.date "invoice_date"
    t.boolean "brandowner_approved_suppliers", default: false
    t.string "generate_new_job_number"
    t.string "client_type"
    t.string "client"
    t.integer "carry_over_id"
    t.boolean "red_status"
    t.boolean "yellow_status"
    t.boolean "green_status"
    ...
    t.index ["job_number"], name: "index_projects_on_job_number", unique: true
  ...
  create_table "tracking_units", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.integer "warehouse_checkin", default: 0
  ...
  create_table "users", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    ...
    t.boolean "permission_projects", default: true
    t.boolean "permission_tracking_units", default: true
    t.boolean "permission_custom_reports", default: true
    t.boolean "permission_library", default: true
    t.boolean "select_all_brand_owners", default: false
    t.boolean "gdpr_compliant", default: true
